...
function NavBar() {
  ...
  return (
    <div className="rc-nav">
      ...
      <div className="rc-nav-center">
        {!isAuthed && (
          <>
            <button
              type="button"
              className="rc-nav-hamburger-btn"
            ...
            <div className={`rc-nav-pill-wrapper ${isMobileMenuOpen ? 'open' : ''}`}>
              <div className="rc-nav-pill">
                <Link to="/login" onClick={() => setIsMobileMenuOpen(false)}>Post a Ride</Link>
                <a href="#" onClick={(e) => { e.preventDefault(); setIsMobileMenuOpen(false); }}>Support</a>
                <Link to="/login" onClick={() => setIsMobileMenuOpen(false)}>My Rides</Link>
      ...
      <div className="rc-nav-right" ref={menuRef}>
        {isAuthed && (
          <>
            {/* Notifications Container */}
            <div className="rc-nav-notif-container">
              <button
                type="button"
              ...
              {unreadCount > 0 && (
                <div className="rc-unread-badge" aria-label="Unread notifications">
                  {unreadCount}
                </div>
              )}

              {isNotifOpen && (
                <div className="rc-nav-menu rc-notif-menu" role="menu">
            ...
            <div className="rc-nav-profile-container">
              <button
                type="button"
